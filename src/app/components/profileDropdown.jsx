    ...
    <div className="h-full py-1 px-2 mr-8 w-full">
      <div className="group absolute right-0 top-0">
        <div className="relative z-10 mt-12 mr-12 ">
          <Link href="/portfolio" className="pr-5 pl-2 text-left bg-[#FFED66] text-[#FF5E5B] rounded-tl-lg rounded-b-lg opacity-80 text-xl border-2 border-[#00CECB]">0x3ae...8c9</Link>
        </div>
          <div className="absolute right-0 top-0 mt-4 mr-4 z-30">
            <ProfilePic />
          </div>
          <div className="hidden group-hover:block bg-[#FFED66] border-2 border-[#00CECB] p-8 rounded-tl-lg rounded-b-lg fixed w-64 right-0 top-0 mt-[48px] mr-[32px] z-5">
