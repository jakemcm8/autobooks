...
export default function ProfileDropdown () {
  return (
    <div className="group text-right">
      <Link href="/portfolio" className="bg-[#FFED66] text-[#FF5E5B] rounded-tl-lg rounded-b-lg opacity-80  py-1 px-2 top-0 mt-4 mr-8 right-0 text-xl z-10 fixed group-hover:border-2 group-hover:border-[#00CECB]">0x3ae...8c9</Link>
