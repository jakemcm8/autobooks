...
export default function ProfileDropdown () {
  return (
    <div className=" flex flex-rowtext-right h-full py-1 px-2 top-0 mt-4 mr-8 right-0">
      <div className="group">
        <Link href="/portfolio" className="bg-[#FFED66] text-[#FF5E5B] rounded-tl-lg rounded-b-lg opacity-80 right-0 text-xl z-10 fixed border-2 border-[#00CECB]">0x3ae...8c9</Link>
          <div className="right-0 h-12">
            <ProfilePic />
          </div>
